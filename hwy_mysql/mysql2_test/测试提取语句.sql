...
DROP TABLE IF EXISTS `mysql2_test`.`avatar`;
DROP TABLE IF EXISTS `mysql2_test`.`comment`;
DROP TABLE IF EXISTS `mysql2_test`.`dynamic`;
DROP TABLE IF EXISTS `mysql2_test`.`dynamic_label`;
DROP TABLE IF EXISTS `mysql2_test`.`label`;
DROP TABLE IF EXISTS `mysql2_test`.`pictures`;
DROP TABLE IF EXISTS `mysql2_test`.`users`;
CREATE TABLE `avatar` (
